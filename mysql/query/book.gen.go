...
func newBook(db *gorm.DB, opts ...gen.DOOption) book {
	...
	_book.Authors = field.NewString(tableName, "authors")
	_book.Publisher = field.NewString(tableName, "publisher")
	_book.Price = field.NewFloat64(tableName, "price")
	_book.Keywords = field.NewString(tableName, "keywords")
...
func (b *book) updateTableName(table string) *book {
	...
	b.Authors = field.NewString(table, "authors")
	b.Publisher = field.NewString(table, "publisher")
	b.Price = field.NewFloat64(table, "price")
	b.Keywords = field.NewString(table, "keywords")
...
func (b *book) fillFieldMap() {
	...
	b.fieldMap["authors"] = b.Authors
	b.fieldMap["publisher"] = b.Publisher
	b.fieldMap["price"] = b.Price
	b.fieldMap["keywords"] = b.Keywords
