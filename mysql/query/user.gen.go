...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.CreditRating = field.NewInt32(tableName, "credit_rating")
...
func (u *user) updateTableName(table string) *user {
	...
	u.CreditRating = field.NewInt32(table, "credit_rating")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["credit_rating"] = u.CreditRating
